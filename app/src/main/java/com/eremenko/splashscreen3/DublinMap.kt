...
class DublinMap : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        map.addMarker(MarkerOptions().position(dublinSpier).title("Marker in Spier"))
        map.moveCamera(CameraUpdateFactory.newLatLng(dublinGreen))
        //  ZOOM LEVEL

        map.moveCamera(CameraUpdateFactory.newLatLngZoom(dublinSpier, 15f))
        map.moveCamera((CameraUpdateFactory.newLatLngZoom(dublinSpier, zoomLevel )))

        // ADD MARKER
        map.addMarker(MarkerOptions().position(dublinSpier).title("Marker Dublin Spier"))
